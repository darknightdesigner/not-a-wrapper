# ChatGPT Prompt Input — HTML

Paste the full HTML of the ChatGPT prompt input/composer area below.
...
> - Primary actions: plus/attachments (`#composer-plus-btn`), dictate button, voice/start button
...
> - Dictation/voice controls are visible and enabled
>
> **Fidelity note:**
          ...
          <form class="group/composer w-full" style="view-transition-name:var(--vt-composer)" data-type="unified-composer">
            ...
            <div class="">
              ...
              >
                ...
                <!-- Trailing actions: dictate + voice -->
                        ...
                        <div>
                          <div class="relative">
                            <button
                              ...
                              class="composer-submit-button-color text-submit-btn-text flex h-9 w-9 items-center justify-center rounded-full transition-colors hover:opacity-70 focus-visible:outline-black focus-visible:outline-none disabled:text-[#f4f4f4] disabled:opacity-30 dark:focus-visible:outline-white"
