# ChatGPT Sidebar — Collapsed HTML

Paste the full HTML of the ChatGPT sidebar in its **collapsed** state below.
...
>
  <div class="relative flex h-full flex-col">
    ...
    <!-- EXPANDED PANEL -->
    <div class="pointer-events-none opacity-0 motion-safe:transition-opacity motion-safe:duration-150 motion-safe:ease-linear h-full w-(--sidebar-width) overflow-x-clip overflow-y-auto text-clip whitespace-nowrap bg-(--sidebar-bg,var(--bg-elevated-secondary))" inert="">
