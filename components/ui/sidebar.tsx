  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "relative w-(--sidebar-width) bg-transparent motion-safe:transition-[width] duration-150 ease-linear",
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) motion-safe:transition-[left,right,width] duration-150 ease-linear md:flex",
          side === "left"
...
function SidebarGroupLabel({
  ...
  const adapted = adaptSlotAsChild(asChild, children, "div")
  return useRender({
